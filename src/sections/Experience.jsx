...
export default function Experience() {
  return (
    <section id="experience" className="py-20 md:py-28 lg:py-32 bg-[#F9FAFB]">
      <SectionReveal>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 2xl:max-w-[1400px]">
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="absolute left-[20px] sm:left-8 top-0 bottom-0 w-[1px] bg-gradient-to-b from-[#2563EB] via-[#7c3aed]/30 to-transparent" />
            ...
            <div className="space-y-10 md:space-y-12">
              {experiences.map((exp, i) => (
                ...
                >
                  <div className="absolute left-[10px] sm:left-4 top-1 w-7 h-7 sm:w-9 sm:h-9 rounded-full bg-white border-2 border-[#2563EB]/20 flex items-center justify-center z-10">
                  ...
                  <GlassCard className="p-5 sm:p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row items-start justify-between mb-3 gap-2">
                      <div>
                        <h3 className="text-base sm:text-lg font-bold text-[#111111]">{exp.role}</h3>
                        <p className="text-sm text-[#2563EB] font-medium">{exp.company}</p>
                      </div>
                      <span className="text-[11px] sm:text-xs text-[#999999] font-medium px-3 py-1 rounded-full bg-[#F9FAFB] border border-[#E5E7EB] whitespace-nowrap">
                        {exp.period}
                      </span>
                    </div>
